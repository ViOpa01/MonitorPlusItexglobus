...
static void sdk_add_demo_aids(TERMINALAPPLIST *TerminalApps)
{
	...
	for(i=20; i<n; i++)
	{
		memcpy(TerminalApps->TermApp[i].abTerminalApplVersion, "0002", 2);/* "\x00\x02"Terminal application version 9F09 9F08 */
...
loop_card:
	...
	//dukpt_prepare_key(0, card_out->pin_ksn);//ksn�ڶ������ȡ����Ҫ������ȡ
