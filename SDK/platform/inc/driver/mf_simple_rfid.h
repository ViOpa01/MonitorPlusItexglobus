...
int mf_rfid_getatr(unsigned char *atr);
int mf_rfid_gettype();
...
int mf_rfid_felica_open(void);
int mf_rfid_felica_close(void);
int mf_rfid_felica_exchange(unsigned char *tbuf, unsigned short tlen, unsigned char *rbuf, unsigned short *rlen, unsigned int milliseconds);
